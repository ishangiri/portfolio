            ...
            <div className="space-y-6">
              ...
              >
                <p className=" sm:text-sm text-xs leading-relaxed">
                  Recent Information Technology graduate with Software
                  Development as major. Experience using modern tools like
                  React.js, Node.js, Next.js, Python (Fast Api), Firebase and
                  React Native (Expo) to build robust and scalable applications.
                  Familiarity using Github Copilot to speed up development and
                  Open AI api to build AI powered web application. A motivated
                  and adaptable developer who learns fast, adapts new technology
                  and is always looking for ways to improve. Whether it's
                  solving technical problems or picking up new tools, I bring
                  persistence and a strong work ethic to everything I do.
                </p>
              </div>
